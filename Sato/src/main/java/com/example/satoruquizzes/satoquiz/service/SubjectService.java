...
public class SubjectService {
    ...
    public SubjectDTO update(Long subjectId, SubjectDTO newSubjectDTO) {
        ...
        if (newSubjectDTO.getParent() != null) {
            Subject newParent = subjectRepository.findById(newSubjectDTO.getParent().getId())
                    .orElseThrow(() -> new NotFoundException("Parent subject not found for ID: " + newSubjectDTO.getParent().getId()));
